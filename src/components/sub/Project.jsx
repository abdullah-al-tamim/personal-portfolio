...
const Project = ({data, index}) => {
  ...
  return (
    ...
    className="relative w-[350px] sm:w-full h-max border border-yellow-400 rounded-lg cursor-pointer">
        ...
        <motion.div initial={{opacity: 0}} animate={{opacity: show ? 1 : 0}} className='absolute top-0 w-full h-full flex flex-col items-center justify-center gap-y-2 bg-white/95 p-6 rounded-lg '>
