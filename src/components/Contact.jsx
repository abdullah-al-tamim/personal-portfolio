    ...
    <div id='contact' className='h-screen lg:h-auto lg:py-40 py-20 '>
        ...
        <div className='w-full h-full my-auto flex lg:flex-col items-center justify-between lg:justify-center gap-x-20 lg:gap-x-0 gap-y-20'>
            ...
            <motion.form initial={{opacity:0, x:150}} whileInView={{opacity:1, x:0}} transition={{duration: .4}} viewport={{once:true}} className='w-[600px] lg:w-[400px] sm:w-full flex flex-col gap-3'>
                ...
                <input type="submit" className='w-full border border-yellow-500 rounded-md bg-yellow-600 px-4 py-2 text-sm font-light tracking-wider text-white outline-none hover:bg-yellow-500 transition-colors cursor-pointer' value={"Send Message"}/>
            </motion.form>
        </div>
    </div>
  )
