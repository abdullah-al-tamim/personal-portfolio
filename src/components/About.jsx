...
import { aboutData, aboutText, arrowLeftIcon, downloadIcon } from '@/assets/index.js'
    ...
    <div className='min-h-screen px-96 flex flex-col items-center justify-center'>
      ...
      <div className='w-full flex items-center justify-between md:justify-center'>
        ...
        <div className='relative max-w-[800px] rounded-xl bg-zinc-100 p-5 text-justify'>
          ...
          <a href="/CV_Abdullah_al_Tamim.pdf" download="" className='w-max flex items-center gap-x-2 mt-6 rounded-full border-gray-300 bg-red-400 px-3 py-2 font-light text-white hover:bg-red-500 hover:font-bold transition-colors '>
